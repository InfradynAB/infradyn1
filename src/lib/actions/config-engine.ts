...
export const DEFAULT_CONFIGS: Record<string, { value: string; type: ConfigValue["type"]; description: string }> = {
    // Delay thresholds
    ...
    "notify_pm_on_duplicate_invoice": {
        value: "true",
        type: "BOOLEAN",
        description: "Immediately notify PM on duplicate invoices"
    },
};
